...
export default function LoginForm() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    if (res?.error) {
      setAuthError(res.error === 'CredentialsSignin' ? 'Invalid email or password.' : res.error)
      return
    }
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1.5">
        ...
        <p className="text-sm text-gray-500">Sign in to your MeetFlow account</p>
      </div>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-gray-50 px-3 text-gray-400 uppercase tracking-wide">or</span>
        </div>
      </div>
